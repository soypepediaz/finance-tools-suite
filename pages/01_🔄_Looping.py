...
import requests
import json
import os  # <--- NECESARIO PARA RAILWAY
...
# ==============================================================================
#  0. GESTIÓN DE SECRETOS (COMPATIBLE STREAMLIT CLOUD Y RAILWAY)
# ==============================================================================
def get_secret(key):
...
def add_subscriber_moosend(name, email):
    ...
    try:
        # Usamos la nueva función get_secret
        api_key = get_secret("MOOSEND_API_KEY")
        
        if not api_key:
            return False, "Falta configuración de API Key (Secrets/Env)."
...
# ==============================================================================
#  3. FUNCIONES AUXILIARES (CONEXIÓN ROBUSTA)
# ==============================================================================
...
def connect_robust(network_name):
    """Intenta conectar rotando RPCs y priorizando Variables de Entorno (Railway)"""
    ...
    # Inyectar secreto (Alchemy/Infura) usando la función compatible
            ...
            # ==================================================================
                ...
                if current_hf <= 1.0:
                    ...
                    for i in range(1, num_defenses + 1):
                        ...
                        # Capital para volver al HF Original
